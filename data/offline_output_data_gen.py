...
if __name__ == "__main__":
    ...
    parser.add_argument('--im-size', type=int, default=256, metavar='N', help='H and W of frames (default: 32)')
    parser.add_argument('--n-balls', type=int, default=3, metavar='N', help='Number of bouncing balls (default: 3)')
    parser.add_argument('--n-frames', type=int, default=100, metavar='N', help='Number of frames per sample (default: 128)')
    parser.add_argument('--rep-times', type=int, default=1, metavar='N', help='Number of times consecutive frames are repeated. No rep is equal to 1 (default: 4)')
    parser.add_argument('--n-samples', type=int, default=100, metavar='N', help='Number of output samples (default: 500)')
    parser.add_argument('--output-path', type=str, default='./', metavar='Path', help='Path for output')
    parser.add_argument('--file-name', type=str, default='tr500_600.hdf', metavar='Path', help='Output file name')
